...
export default async function Page() {
  return (
    <div className="flex flex-col space-y-10 justify-between items-center pt-12 w-10/12 mx-auto">
      <form
        action={addPost}
        className="mt-12 flex blog-break:flex-row flex-col flex-wrap blog-break:flex-nowrap rounded-2xl bg-m-green py-10 px-5 w-full min-h-[12rem] p-4 shadow blog-break:items-start items-center justify-center"
      >
        ...
        <div className="flex flex-col w-5/6">
          ...
          <div className="flex flex-row justify-end pt-16 pb-4">
            <button className="rounded-full bg-slate-400 p-2 md:mx-4 text-deep-green hover:bg-slate-300/70">
              Cancel
            </button>
            <button
