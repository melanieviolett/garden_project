...
const Card = ({ d }) => {
  return (
    <div
      key={d.id}
      className="w-72 min-h-[16rem] p-4 rounded-lg shadow bg-[#E0AFA5] flex flex-col items-center"
    >
      <div className=" w-full flex items-center mb-5">
        ...
        <h5 className="text-lg capitalize font-bold text-deep-green">{d.common_name}</h5>
      </div>

      <div className="w-full mb-5">
        <div className="font-normal text-deep-green flex items-center">
          <GrPowerCycle className="mr-1" />
          <p className="font-medium capitalize">Cycle: {" " + d.cycle}</p>
        </div>
        ...
        <div className="font-normal text-deep-green flex items-center capitalize">
